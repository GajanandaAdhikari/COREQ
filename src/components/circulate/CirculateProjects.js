  ...
  return (
    <>
      ...
      <div className=' max-sm:w-[350px] max-md:w-[350px] lg:w-[600px] 2xl:w-[900px]  p-4 border border-boderColor rounded-lg mt-5 '>
        ...
        <UploadPDF message={"Upload Project Details PDF"}></UploadPDF>
        <div className='flex justify-center mt-5'>
        <button class=" bg-green-500  hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full">Draft</button>
        <button class="ml-10  bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full" onClick={HandleSubmitProject}>Submit</button>
        </div>
      </div>
