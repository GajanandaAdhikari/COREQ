    ...
    <>
      <div className="bg-back-color  h-screen md:h-full">
        ...
        <div class="w-2/3 mx-auto mb-10 pb-20 pt-20 mt-20">
          ...
          <span className="flex mt-8"> <FontAwesomeIcon icon={faTwitter} size="3x" /> <input class="ml-6 justify-center  shadow appearance-none border border-bcolor rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="twitterUsername" type="text" placeholder="Twitter Username" /></span>
